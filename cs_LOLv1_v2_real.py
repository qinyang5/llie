...
parser.add_argument('-opt', type=str, default='./options/test/LOLv1.yml', help='Path to options YMAL file.')
...
def main():
    ...
    for phase, dataset_opt in opt['datasets'].items():
        ...
        for val_data in val_loader:
            ...
            if save_imgs:
                try:
                    tag = '{}'.format(val_data['folder'][0])
                    print(osp.join(output_folder, '{}'.format(tag)))
